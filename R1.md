...
- **Debugging Metamask Compatibility Issues**
    ...
    - **Temporary Solution: ** *Since I'm lazy to setup the lower versions. I remember I still have metamask lower version in my Brave browser. Luckily I didn't update it yet so I will be using my Brave browser for now to the testing of the version.*
